...
<AccordionGroup>
  <Accordion title="Completely Free & Open Source" icon="code-branch">
    Reactive Resume is licensed under MIT. You can use it for free, modify it, and even host your own instance. The entire codebase is available on [GitHub](https://github.com/pickit420/reactive-resume-v2).
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="GitHub" icon="github" href="https://github.com/pickit420/reactive-resume-v2">
  ...
  <Card title="Discord" icon="discord" href="https://discord.com/servers/lazy-media-s-reactive-resume-1392393638247530587">
    Join our Discord server to get help and connect with other users.
  </Card>
  <Card title="Sponsor" icon="heart" href="https://buymeacoffee.com/lazymedia">
    Support the development and long-term sustainability of Reactive Resume.
  </Card>
</CardGroup>

<Note>
  **Need help?** Feel free to reach out via [email](mailto:support@lazymedia.media) or open an issue on GitHub.
</Note>
