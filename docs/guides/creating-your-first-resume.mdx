...
<Steps>
  <Step title="Log in to your account">
    Head over to [https://rxresume.org](https://rxresume.org) and log in with your account credentials.
  ...
  <Step title="Review (or edit) the slug">
    ...
    <Warning>
      If you choose to publicly share your resume, it will be accessible at `https://rxresume.org/{username}/{slug}`.
    </Warning>
  </Step>
