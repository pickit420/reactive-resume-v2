...
<Steps>
  <Step title="Sign in to the dashboard">
    Head over to [https://rxresume.org](https://rxresume.org) and sign in with your account credentials.
  </Step>
  ...
  <Step title="Open the API reference">
    ...
    <Tip>
      You can also open it directly here: [API Reference](https://docs.rxresume.org/api-reference).
    </Tip>
  </Step>
  ...
  <Step title="Authenticate requests with x-api-key">
    ...
    <Info>
      If you're self-hosting, replace <code>https://rxresume.org</code> with your instance URL. The API is served under <code>/api/openapi</code>.
    </Info>

    ```bash
    curl "https://rxresume.org/api/openapi/resume/list" \
