		...
		<SectionBase type="information" className="space-y-4">
			<div className="space-y-2 rounded-md border bg-sky-600 p-5 text-white dark:bg-sky-700">
				...
				<div className="space-y-2 text-xs leading-normal">
					<Trans>
						<p>
							Thank you for using Reactive Resume! This app is a labor of love, created mostly in Amruth Pillai's spare
							time, with wonderful support from open-source contributors around the world.
						</p>
						<p>
			...
			<div className="flex flex-wrap gap-0.5">
				...
				<Button asChild size="sm" variant="link" className="text-xs">
					<a href="https://github.com/pickit420/reactive-resume-v2" target="_blank" rel="noopener">
						<Trans>Source Code</Trans>
					</a>
				</Button>

				<Button asChild size="sm" variant="link" className="text-xs">
					<a href="https://github.com/pickit420/reactive-resume-v2/issues" target="_blank" rel="noopener">
						<Trans>Report a Bug</Trans>
					</a>
				</Button>

				<Button asChild size="sm" variant="link" className="text-xs">
					<a href="https://crowdin.com/project/lazymedia-reactive-resume" target="_blank" rel="noopener">
